...
background_image=PhotoImage(file=r"C:/Users/jcsch/Downloads/Ux-Jainct/Camada1.png")
...
#Directory
mudardiretorioimg = PhotoImage(file=r"C:/Users/jcsch\Downloads/Ux-Jainct/diretoriosave.png")
...
#Additional Info
text = Label(ux,font='Arial,14',text='GrimD Ver 1.1.2 - Made by JaintC - Ux by Biskatuxa', bg = '#6d4e6e',fg = 'white')
